 ...
 */
class BusinessOaConfigurationLoader internal constructor(
    private val environment: Map<String, String> = System.getenv(),
    private val bundledDefault: () -> InputStream?,
    private val bootstrapInstaller: BusinessOaConfigurationBootstrapInstaller,
) {
    constructor(
    ...
    ) : this(environment, bundledDefault, AtomicBusinessOaConfigurationBootstrap())
