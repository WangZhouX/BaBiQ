...
internal fun interface BusinessOaConfigurationBootstrapInstaller {
    fun installIfAbsent(target: Path, bundledDefault: () -> InputStream?)
}

/** 可注入的最小文件操作边界，用于精确覆盖 fsync 与原子安装失败。 */
internal interface BusinessOaConfigurationBootstrapFileOperations {
...
internal object NioBusinessOaConfigurationBootstrapFileOperations :
    BusinessOaConfigurationBootstrapFileOperations {
 ...
 */
internal class AtomicBusinessOaConfigurationBootstrap(
    private val fileOperations: BusinessOaConfigurationBootstrapFileOperations =
        NioBusinessOaConfigurationBootstrapFileOperations,
) : BusinessOaConfigurationBootstrapInstaller {
