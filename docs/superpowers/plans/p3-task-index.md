...
| P3-6 | 已完成 | 技能层薄封装官方 SkillRegistry：FileSystemSkillRegistry + `.agents/skills` 路径 + allowedTools 元数据 | `docs/superpowers/plans/p3-6-skill-official-registry/plan.md` | P3-5a |
